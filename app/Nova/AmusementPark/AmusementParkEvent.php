...
class AmusementParkEvent extends Resource
{
    /**
     ...
     */
    public static $model = \App\Models\AmusementParkEvent::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Image::make(__('Изображение'), 'image')->hideFromIndex()->help('Размер изображения: ШхB 380х380 (px) Формат: .jpg, .jpeg, .png'),
